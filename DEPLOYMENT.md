...
1. Read the comprehensive [Oracle Cloud Deployment Guide](ORACLE_CLOUD_DEPLOYMENT.md).
2. Provision an Always Free Ampere A1 Compute Instance.
3. Run the bot using PM2 or Docker.
